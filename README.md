...
The dataset contains **4,800 simulated operating scenarios** generated from two public MATPOWER distribution-network benchmarks. The source cases provide bus loads, branch impedances and network connectivity; the included code generates operating conditions, incomplete telemetry and power-flow targets. The scenario dataset is generated for this study and is not a collection of field measurements.

| Benchmark and official source | Network | Use in this dataset | Original reference |
| --- | --- | --- | --- |
| [MATPOWER case33bw](https://github.com/MATPOWER/matpower/blob/master/data/case33bw.m) | 33 buses, 12.66 kV | 4,000 scenarios across 60 radial topologies; primary training and evaluation | [Baran and Wu (1989), DOI: 10.1109/61.25627](https://doi.org/10.1109/61.25627) |
| [MATPOWER case69](https://github.com/MATPOWER/matpower/blob/master/data/case69.m) | 69 buses, 12.66 kV | 800 scenarios; external-feeder evaluation and local adaptation | [Baran and Wu (1989), DOI: 10.1109/61.19265](https://doi.org/10.1109/61.19265) |

Each scenario includes network and telemetry features, with **minimum voltage (p.u.), active power loss (kW) and feasibility (0/1)** as targets. The ready-to-use [scenario arrays](dataset/processed/scenario_arrays.npz), [scenario metadata](dataset/processed/scenario_metadata.csv) and [dataset documentation](dataset/README.md) are included in the repository. The original benchmark references above should be cited when using their electrical network data; [source provenance](dataset/raw/source_provenance.csv) records both sources.
