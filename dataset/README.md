...
The electrical benchmarks are derived from two public MATPOWER cases:

- **33-bus network:** [official case33bw data](https://github.com/MATPOWER/matpower/blob/master/data/case33bw.m), from Baran and Wu (1989), [DOI: 10.1109/61.25627](https://doi.org/10.1109/61.25627).
- **69-bus network:** [official case69 data](https://github.com/MATPOWER/matpower/blob/master/data/case69.m), from Baran and Wu (1989), [DOI: 10.1109/61.19265](https://doi.org/10.1109/61.19265).

Both use a nominal voltage of 12.66 kV. Their identifiers, source links and original references are also recorded in [`raw/source_provenance.csv`](raw/source_provenance.csv). The simulation code uses the local numerical definitions in [`src/benchmarks.py`](../src/benchmarks.py). Cite the original references above when using the electrical benchmark data; the 4,800 scenario observations are generated by this repository's simulation pipeline.
